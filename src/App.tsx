  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <p>
          Lembre-se você pode utilizar a variável <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da tanscrição do víde selecionado.
        </p>
        </div>
        ...
        <aside className="w-80 space-y-6">
          ...
          <form className="space-y-6">
            ...
            <Select disabled defaultValue="gpt3.5">
              ...
              <SelectContent>
                <SelectItem value="gpt3.5">GPT 3.5-turbo 1</SelectItem>
              </SelectContent>
            </Select>
            <span 
